...
════════════════════════════════════════════════════════ */
const IMAGES = {
  // Hero background — tanker truck on highway, wide landscape
  ...
  // Pro Tip section — road or highway mood shot for background
  proTipBg: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1400&q=80",

  // Gallery strip — 3 supporting field/training images
  ...
  // Testimonial avatars — null shows initials placeholder
...
const UsersIcon = ({ size = 28, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
/* ════════════════════════════════════════════════════════
   BOOK COVER — real image or styled placeholder
   Swap: set IMAGES.bookCover = "/images/book-cover.jpg"
════════════════════════════════════════════════════════ */
function BookCover() {
  if (IMAGES.bookCover) {
    return (
      /*
        img tag — displays at the image's natural aspect ratio.
        maxWidth caps it so it doesn't blow out the hero grid.
        Remove maxWidth / adjust to taste once you see the real dimensions.
      */
      <img
        src={IMAGES.bookCover}
        alt="Fuel Hauling Made Easy — Student Workbook cover"
        style={{
          maxWidth: 480,
          width: "100%",
  ...
  // Styled placeholder — remove this branch once the real cover is set
  return (
    <div style={{
      width: 300, aspectRatio: "3/4",
      background: `linear-gradient(160deg, ${T.navyMid} 0%, ${T.navy} 100%)`,
      borderRadius: 8, border: `1px solid ${T.borderDark}`,
      ...
      <div style={{ textAlign: "center", zIndex: 1 }}>
        <div style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 22, color: "#fff", textTransform: "uppercase", lineHeight: 1.1, letterSpacing: "0.03em", marginBottom: 8 }}>
          Fuel Hauling<br/>Made Easy
        </div>
        <div style={{ fontFamily: "var(--font-body)", fontSize: 12, color: T.textDim, lineHeight: 1.5 }}>
      ...
      <div style={{ fontFamily: "var(--font-body)", fontSize: 11, color: T.gold, letterSpacing: "0.12em", textTransform: "uppercase", textAlign: "center" }}>
        Student Workbook
      </div>
      <div style={{ position: "absolute", top: 12, right: 12, background: "rgba(232,97,10,0.2)", border: "1px dashed rgba(232,97,10,0.5)", borderRadius: "var(--radius-sm)", padding: "3px 8px", fontFamily: "var(--font-body)", fontSize: 10, color: T.orange, letterSpacing: "0.08em", textTransform: "uppercase" }}>
        Cover Placeholder
      </div>
    </div>
  );
...
/* ════════════════════════════════════════════════════════
   SECTION 1 — HERO  (photo background + book cover)
   Swap: IMAGES.hero, IMAGES.bookCover
════════════════════════════════════════════════════════ */
function Hero() {
  return (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }} className="hero-grid">
          ...
          <div>
            ...
            <p style={{
              ...
              color: "rgba(255,255,255,0.75)", lineHeight: 1.75, marginBottom: 36, maxWidth: 520,
            }}>
          ...
          {/* Right — book cover (landscape or portrait, never cropped) */}
          <div style={{
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            minWidth: 0,        // allows grid column to shrink below content size
          }}>
            <BookCover/>
          </div>
        </div>
...
/* ════════════════════════════════════════════════════════
   ...
   3 field photos with hover zoom and captions.
      ...
      {photos.map((photo, i) => (
        <div key={i} style={{ position: "relative", aspectRatio: "4/3", overflow: "hidden" }}>
          ...
          <div style={{
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.72)", fontStyle: "italic" }}>
              {photo.caption}
            </p>
          </div>
        </div>
...
function WhatsInside() {
  const features = [
    { icon: <BookIcon size={28} color={T.orange}/>,      title: "10-Day Comprehensive Training Curriculum",          body: "A structured, day-by-day system that takes you from the basics all the way through advanced leadership — no experience required to start." },
    { icon: <ClipboardIcon size={28} color={T.orange}/>, title: "Step-by-Step Loading & Unloading Procedures",       body: "Every step documented clearly, with checklists you can use at the terminal. Never second-guess the process again." },
    { icon: <ShieldIcon size={28} color={T.orange}/>,    title: "Cross-Contamination & Spill Prevention Strategies", body: "Learn the exact techniques to prevent costly cross-dumps, spills, and contamination incidents that can end careers." },
    { icon: <UsersIcon size={28} color={T.orange}/>,     title: "Driver Trainer Excellence & Leadership Modules",    body: "Ready to move up? This section prepares you to train others — covering coaching techniques, communication, and accountability." },
    { icon: <AwardIcon size={28} color={T.orange}/>,     title: "Certification Readiness & Assessment Tools",        body: "Built-in quizzes, self-assessments, and readiness checklists so you know exactly when you're prepared to certify." },
  ];
    ...
    <section className="section section--surface">
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: T.textMuted, maxWidth: 540, margin: "0 auto", lineHeight: 1.7 }}>
...
/* ════════════════════════════════════════════════════════
   SECTION 4 — PRO TIP  (moody photo background)
   Swap: IMAGES.proTipBg
════════════════════════════════════════════════════════ */
function ProTip() {
  return (
    <section style={{ position: "relative", overflow: "hidden", padding: "100px 0" }}>
      ...
      <div style={{
        position: "absolute", inset: 0, zIndex: 0,
        backgroundImage: `url('${IMAGES.proTipBg}')`,
        backgroundSize: "cover", backgroundPosition: "center",
      }}/>
      {/* Very dark overlay — quote always readable */}
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        <div style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ marginTop: 28, fontFamily: "var(--font-body)", fontSize: 15, color: T.textDim, lineHeight: 1.7 }}>
...
/* ════════════════════════════════════════════════════════
   SECTION 5 — WHO IS THIS FOR  (driver photo + floating badges)
   Swap: IMAGES.driverAtTerminal
════════════════════════════════════════════════════════ */
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 64, alignItems: "center" }} className="who-split-grid">
          ...
          <div style={{ position: "relative" }}>
            <div style={{
              ...
              aspectRatio: "4/5",
              backgroundImage: `url('${IMAGES.driverAtTerminal}')`,
              backgroundSize: "cover", backgroundPosition: "center",
              boxShadow: "0 32px 80px rgba(0,0,0,0.18)",
            }}/>

            {/* Curriculum badge bottom-right */}
            <div style={{
              position: "absolute", bottom: -20, right: -20,
              background: T.orange, borderRadius: "var(--radius-md)",
              padding: "20px 24px", boxShadow: "0 12px 40px rgba(232,97,10,0.4)",
            }}>
              <div style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 42, color: "#fff", lineHeight: 1 }}>10</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.85)", marginTop: 2 }}>Day Curriculum</div>
            </div>
            ...
            <div style={{
              ...
              border: `2px solid ${T.gold}`, padding: "14px 20px",
              textAlign: "center", boxShadow: "0 8px 28px rgba(0,0,0,0.3)",
            }}>
              <div style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 28, color: T.gold, lineHeight: 1 }}>$79</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 11, color: T.textDim, marginTop: 2 }}>One-time</div>
            </div>

            {/* Gold accent bar */}
            <div style={{ position: "absolute", top: 24, right: -8, width: 6, height: 80, background: T.gold, borderRadius: 3 }}/>
          </div>

          {/* Right — audience list */}
          <div>
            <p className="text-label text-orange" style={{ marginBottom: 12 }}>Is This for Me?</p>
            <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "clamp(28px, 3.5vw, 48px)", color: T.navy, marginBottom: 28 }}>
            ...
            {/* Trainer upgrade nudge */}
            <div style={{
              marginTop: 24, padding: "20px 24px",
              background: `rgba(200,168,75,0.06)`, border: `1px solid rgba(200,168,75,0.2)`,
              borderLeft: `4px solid ${T.gold}`, borderRadius: "var(--radius-md)",
              display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap",
            }}>
              <div>
                <p style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 15, color: T.navy, textTransform: "uppercase", letterSpacing: "0.03em", marginBottom: 4 }}>Ready to Train Others?</p>
                <p style={{ fontFamily: "var(--font-body)", fontSize: 13.5, color: T.textMuted, lineHeight: 1.5 }}>The Certified to Lead™ workshop is the next step.</p>
              </div>
              <a href="/certified-to-lead-workshop" className="btn btn--navy" style={{ flexShrink: 0 }}>
                Explore Workshop
    ...
    <section id="buy" style={{ background: T.surface, padding: "88px 0" }}>
      <div className="container">
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", background: T.surfaceWhite, borderRadius: "var(--radius-md)", border: `1px solid ${T.border}`, borderTop: `5px solid ${T.orange}`, overflow: "hidden", boxShadow: "var(--shadow-lg)" }}>
          <div style={{ background: T.navy, padding: "36px 40px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap" }}>
            <div>
              <div style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 64, color: "#fff", lineHeight: 1 }}>$79</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 14, color: T.textDim, marginTop: 4 }}>One-time purchase · Instant PDF download</div>
            </div>
            <div style={{ background: "rgba(232,97,10,0.15)", border: `1px solid rgba(232,97,10,0.3)`, borderRadius: "var(--radius-sm)", padding: "12px 20px", textAlign: "center" }}>
          ...
          <div style={{ padding: "32px 40px" }}>
            <p style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase", color: T.textMuted, marginBottom: 20 }}>Everything included:</p>
      ...
      <div className="container">
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "clamp(28px, 3.5vw, 46px)", color: "#fff", marginBottom: 16 }}>
              Want a Free Sample First?
            </h2>
            <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: T.textDim, lineHeight: 1.7 }}>
          ...
          <div style={{ background: T.navyLight, borderRadius: "var(--radius-md)", border: `1px solid ${T.borderDark}`, borderTop: `4px solid ${T.gold}`, overflow: "hidden" }}>
            <div style={{ padding: "28px 36px", borderBottom: `1px solid ${T.borderDark}`, display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
              <div style={{ width: 52, height: 52, background: "rgba(200,168,75,0.12)", border: `1px solid rgba(200,168,75,0.25)`, borderRadius: "var(--radius-md)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <DownloadIcon size={24} color={T.gold}/>
              </div>
              <div>
                <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 17, color: "#fff", textTransform: "uppercase", letterSpacing: "0.04em" }}>Fuel Drop Site Checklist — PDF</div>
                <div style={{ fontFamily: "var(--font-body)", fontSize: 13.5, color: T.textDim, marginTop: 4 }}>From Appendix D of the Fuel Hauling Made Easy workbook</div>
              </div>
              <div style={{ marginLeft: "auto", fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 22, color: T.gold }}>FREE</div>
            </div>

            <div style={{ padding: "32px 36px" }}>
              {submitted ? (
                <div style={{ textAlign: "center", padding: "20px 0" }}>
                  <div style={{ width: 56, height: 56, borderRadius: "50%", background: "rgba(34,197,94,0.12)", border: "2px solid rgba(34,197,94,0.4)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
                  ...
                  <p style={{ fontFamily: "var(--font-body)", fontSize: 15, color: T.textDim, lineHeight: 1.6 }}>
                    The checklist is on its way to <strong style={{ color: "#fff" }}>{email}</strong>.
                    Get the full workbook for $79 and complete your training.
                  </p>
    ...
    <section className="section section--white">
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "clamp(26px, 3vw, 42px)", color: T.navy }}>
          ...
          {testimonials.map(t => (
            <div key={t.name} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                {/* Shows real photo if available, falls back to gradient initials */}
                {t.photo ? (
                  <div style={{
                    width: 48, height: 48, borderRadius: "50%",
                    backgroundImage: `url('${t.photo}')`,
                    backgroundSize: "cover", backgroundPosition: "center",
                    flexShrink: 0, border: `2px solid ${T.orange}`,
                  }}/>
                ) : (
                  <div style={{
                    width: 48, height: 48, borderRadius: "50%",
                    ...
                    <span style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 15, color: "#fff" }}>{t.initials}</span>
                  </div>
                )}
                <div>
  ...
  return (
    <section style={{ background: T.navy, padding: "88px 0", position: "relative", overflow: "hidden" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--font-body)", fontSize: 17, color: T.textDim, lineHeight: 1.7, maxWidth: 500, margin: "0 auto 40px" }}>
          One workbook. $79. A career's worth of practical,
          field-tested knowledge delivered straight to your inbox.
        </p>
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
          <a href="https://vanguardbusinessconsultantsllc.com/product/fuel-hauling-made-easy-the-complete-training-leadership-guide/"
            className="btn btn--orange btn--lg btn--pulse">
        ...
        <p style={{ marginTop: 20, fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.28)" }}>
  ...
  return (
    <main>
      ...
      <style jsx>{`
        ...
        .who-split-grid    { grid-template-columns: 1fr 1fr; }
        ...
        @media (max-width: 860px) {
          ...
          .who-split-grid { grid-template-columns: 1fr; }
        }
