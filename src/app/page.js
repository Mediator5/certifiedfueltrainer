      ...
      <div className="container" style={{ position: "relative", zIndex: 3, padding: "100px 24px 96px" }}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            letterSpacing: "0.16em", textTransform: "uppercase", color: T.gold,
          }}>
    ...
    <section className="section section--surface">
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          <p className="text-label text-gold" style={{ marginBottom: 12 }}>What You'll Learn</p>
          <h2 style={{
            fontFamily: "var(--font-display)", fontWeight: 900,
            fontSize: "clamp(28px, 4vw, 50px)", color: T.navy, marginBottom: 14,
          }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }} className="value-grid">
          {items.map((item, i) => (
            ...
            >
              <div style={{
                width: 52, height: 52, flexShrink: 0, background: T.navy,
                borderRadius: "var(--radius-md)",
              ...
              <div>
                <p style={{ fontFamily: "var(--font-body)", fontSize: 12.5, color: T.textMuted, fontStyle: "italic", marginBottom: 6, lineHeight: 1.5 }}>"{item.problem}"</p>
                <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 18, color: T.navy, textTransform: "uppercase", letterSpacing: "0.03em", marginBottom: 8 }}>{item.solution}</h3>
                <p style={{ fontFamily: "var(--font-body)", fontSize: 14.5, color: T.textMuted, lineHeight: 1.7 }}>{item.body}</p>
              </div>
            </div>
          ))}
        </div>
...
function GalleryStrip() {
  const photos = [
    { src: IMAGES.gallery1, caption: "On the road — real field conditions" },
    { src: IMAGES.gallery2, caption: "Workshop training session in progress" },
    { src: IMAGES.gallery3, caption: "Hands-on safety procedure review" },
  ];
      ...
      {photos.map((photo, i) => (
        <div key={i} style={{ position: "relative", aspectRatio: "4/3", overflow: "hidden" }}>
          ...
          <div style={{
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.7)", fontStyle: "italic" }}>
              {photo.caption}
            </p>
          </div>
        </div>
      ...
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="who-grid">
          ...
          <div>
            ...
            <h2 style={{
              fontFamily: "var(--font-display)", fontWeight: 900,
              fontSize: "clamp(28px, 3.5vw, 48px)", color: "#fff", marginBottom: 24,
            }}>
            ...
            <div style={{
              ...
              background: "rgba(255,255,255,0.04)", border: `1px solid ${T.borderDark}`,
              borderRadius: "var(--radius-md)",
            }}>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 14, color: "rgba(255,255,255,0.45)", lineHeight: 1.6 }}>
                <strong style={{ color: T.textDim }}>New to fuel hauling?</strong> Start with the{" "}
                <a href="/fuel-hauling-made-easy" style={{ color: T.orange, borderBottom: `1px solid rgba(232,97,10,0.4)`, transition: "border-color var(--ease-fast)" }}
            ...
            <div style={{
              ...
              {[
                ...
                <div key={row.label} style={{
                  ...
                  borderBottom: i < arr.length - 1 ? `1px solid ${T.borderDark}` : "none",
                }}>
                  <span style={{ display: "flex", alignItems: "center", gap: 8, fontFamily: "var(--font-body)", fontSize: 13, color: T.textDim }}>{row.icon}{row.label}</span>
                  <span style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 14, color: "#fff" }}>{row.value}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="included-split-grid">
          ...
          <div>
            ...
            <h2 style={{
              fontFamily: "var(--font-display)", fontWeight: 900,
              fontSize: "clamp(26px, 3.5vw, 46px)", color: T.navy, marginBottom: 32,
            }}>
              ...
              {included.map(item => (
                ...
                >
                  <div style={{
                    ...
                    background: "rgba(232,97,10,0.08)", border: `1px solid rgba(232,97,10,0.18)`,
                  ...
                  <div>
                    <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 16, color: T.navy, textTransform: "uppercase", letterSpacing: "0.03em", marginBottom: 5 }}>{item.title}</h3>
                    <p style={{ fontFamily: "var(--font-body)", fontSize: 14, color: T.textMuted, lineHeight: 1.65 }}>{item.body}</p>
                  </div>
                </div>
              ))}
            </div>
            <p style={{ marginTop: 20, fontFamily: "var(--font-body)", fontSize: 14, color: T.textMuted }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{
              ...
              <div style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: 14, color: "#fff", textTransform: "uppercase", letterSpacing: "0.06em" }}>1-Day Workshop</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "rgba(255,255,255,0.8)", marginTop: 2 }}>MetroTech · Oklahoma City</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }} className="cert-grid">
          ...
          <div>
            ...
            <h2 style={{
              fontFamily: "var(--font-display)", fontWeight: 900,
              fontSize: "clamp(28px, 3.5vw, 48px)", color: "#fff", marginBottom: 20,
            }}>
              Earn Your Official Fuel Driver Trainer Certificate.
            </h2>
            <p style={{ fontFamily: "var(--font-body)", fontSize: 16, color: T.textDim, lineHeight: 1.75, marginBottom: 28 }}>
              ...
              {[
                ...
                <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                  <div style={{
                    ...
                    background: "rgba(200,168,75,0.15)", border: `1px solid ${T.gold}`,
                    display: "flex", alignItems: "center", justifyContent: "center",
                    flexShrink: 0, marginTop: 1,
                  }}>
    ...
    <section id="register" style={{ background: T.surface, padding: "88px 0" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <p className="text-label text-orange" style={{ marginBottom: 12 }}>Pricing & Registration</p>
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "clamp(28px, 4vw, 50px)", color: T.navy }}>
            ...
            <div style={{ background: T.navy, padding: "36px 44px" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-end", gap: 16 }}>
                ...
                <div style={{ paddingBottom: 8 }}>
                  <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 28, color: "rgba(255,255,255,0.3)", textDecoration: "line-through" }}>$995</div>
                  <div style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "rgba(255,255,255,0.3)" }}>Standard Rate</div>
                </div>
              </div>
            </div>
...
function Testimonials() {
  ...
  return (
    <section className="section section--white">
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <p className="text-label text-gold" style={{ marginBottom: 12 }}>What Attendees Are Saying</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }} className="testimonials-grid">
          {testimonials.map(t => (
            <div key={t.name} style={{
              ...
              border: `1px solid ${T.border}`, borderLeft: `4px solid ${T.gold}`,
...
function FAQ() {
  ...
  return (
    <section style={{ background: T.surface, padding: "88px 0" }}>
      <div className="container">
        <div style={{ textAlign: "center", marginBottom: 52 }}>
          <p className="text-label text-orange" style={{ marginBottom: 12 }}>Frequently Asked Questions</p>
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "clamp(28px, 3.5vw, 48px)", color: T.navy }}>Got Questions? We've Got Answers.</h2>
        </div>
            ...
            <div key={i} style={{
              ...
              {open === i && (
                <div style={{ padding: "0 24px 22px", borderTop: `1px solid ${T.border}` }}>
                  <p style={{ fontFamily: "var(--font-body)", fontSize: 15.5, color: T.textMuted, lineHeight: 1.75, paddingTop: 16 }}>{faq.a}</p>
                </div>
              )}
            </div>
          ))}
        </div>
        <p style={{ textAlign: "center", marginTop: 32, fontFamily: "var(--font-body)", fontSize: 14.5, color: T.textMuted }}>
          Still have questions?{" "}
          <a href="/contact" style={{ color: T.orange, borderBottom: `1px solid rgba(232,97,10,0.35)`, transition: "border-color var(--ease-fast)" }}
            onMouseEnter={e => e.currentTarget.style.borderBottomColor = T.orange}
    ...
    <section style={{ background: T.navy, padding: "88px 0", position: "relative", overflow: "hidden" }}>
      ...
      <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
        ...
        <p style={{ fontFamily: "var(--font-body)", fontSize: 17, color: T.textDim, lineHeight: 1.7, maxWidth: 500, margin: "0 auto 32px" }}>
          The early bird rate of <strong style={{ color: "#fff" }}>$895</strong> won't last.
        ...
        <p style={{ marginTop: 20, fontFamily: "var(--font-body)", fontSize: 13, color: "rgba(255,255,255,0.28)" }}>
          Limited to 20 participants · MetroTech, Oklahoma City · {WORKSHOP_DATE} · 8:00 AM – 5:00 PM
        </p>
      </div>
    </section>
  );
